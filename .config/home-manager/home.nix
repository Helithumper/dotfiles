...

{
  ...
  home.file = {
    ".config/hypr/lid.sh" = {
      source = ~/src/github.com/helithumper/dotfiles/.config/hypr/lid.sh;
      executable = true;
    };
    ".config/waybar/scripts/weather.py" = {
      source = ~/src/github.com/helithumper/dotfiles/.config/waybar/scripts/weather.py;
      executable = true;
    };
  };
